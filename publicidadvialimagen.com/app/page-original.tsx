...
function FeaturedBillboardsCarousel({ billboards }: { billboards: any[] }) {
  const [emblaRef, emblaApi] = useEmblaCarousel(
    { 
      loop: true,
      align: 'start',
...
export default function HomePage() {
  ...
  const featuredBillboards = [
    ...
    {
      id: 5,
      name: "Valla Digital - Terminal El Alto",
      code: "EA-001",
      images: ["/placeholder.svg?height=300&width=400"],
      monthlyPrice: 3200,
    ...
    {
      id: 6,
      name: "Valla Tradicional - Entrada Sucre",
      code: "SU-001",
      images: ["/placeholder.svg?height=300&width=400"],
      monthlyPrice: 1500,
