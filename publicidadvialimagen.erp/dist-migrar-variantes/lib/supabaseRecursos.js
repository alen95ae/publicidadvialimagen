...
exports.supabaseToRecurso = supabaseToRecurso;
exports.recursoToSupabase = recursoToSupabase;
exports.getAllRecursos = getAllRecursos;
exports.getRecursosPage = getRecursosPage;
exports.getRecursoById = getRecursoById;
exports.createRecurso = createRecurso;
...
const supabase = (0, supabaseServer_1.getSupabaseServer)();
// Convertir de Supabase a formato interno
function supabaseToRecurso(record) {
...
function recursoToSupabase(recurso) {
    const fields = {};
...
async function getRecursosPage(page = 1, pageSize = 50, query, categoria) {
    try {
...
async function getRecursoById(id) {
    ...
    try {
        ...
        console.log('🔄 Recurso convertido - cantidad de variantes:', ((_a = recursoConvertido.variantes) === null || _a === void 0 ? void 0 : _a.length) || 0);
...
// Crear nuevo recurso
async function createRecurso(recurso) {
    try {
...
// Actualizar recurso
async function updateRecurso(id, recurso) {
    try {
