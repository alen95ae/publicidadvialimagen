...
exports.generarCombinacionesVariantes = generarCombinacionesVariantes;
exports.generarClaveVariante = generarClaveVariante;
exports.normalizarClaveProducto = normalizarClaveProducto;
exports.parsearClaveVariante = parsearClaveVariante;
exports.convertirVariantesAFormato = convertirVariantesAFormato;
/**
 ...
 */
function generarCombinacionesVariantes(variantes) {
    if (!variantes || variantes.length === 0) {
        return [];
    }
    // Filtrar variantes que tengan valores válidos
    const variantesValidas = variantes.filter(v => v &&
        v.nombre &&
 ...
 */
function generarClaveVariante(combinacion) {
 ...
 */
function normalizarClaveProducto(combinacion) {
    if (!combinacion || Object.keys(combinacion).length === 0) {
        return "sin_variantes";
    }
 ...
 */
function parsearClaveVariante(clave) {
 ...
 */
function convertirVariantesAFormato(variantes) {
    ...
    variantes.forEach(variante => {
        ...
        if (variante && variante.nombre) {
            ...
            const valores = (_b = (_a = variante.valores) !== null && _a !== void 0 ? _a : variante.posibilidades) !== null && _b !== void 0 ? _b : [];
